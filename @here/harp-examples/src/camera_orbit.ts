...
export namespace CameraOrbitExample {
    ...
    const NY = new GeoCoordinates(40.706, -74.01);
    let t = 0;
    map.addEventListener(MapViewEventNames.Render, () => {
        map.lookAt(NY, options.distance, options.pitch, (t += 0.1));
        updateHTML();
    });
    ...
    function updateHTML() {
        ...
        infoElement.innerHTML =
            ...
            `${options.distance.toFixed(0)}, ${options.pitch.toFixed(1)}, ${t.toFixed(1)});`;
    }
